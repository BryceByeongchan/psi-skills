...
```
psi:bgw-gw-conv-sigma sweep:param values:v1,v2,v3 parent_epsilon:cNNN [calc_id:cNNN] vbm:ik=N,n=M cbm:ik=N,n=M [options...]
```
...
- `calc_id:cNNN` — Optional base calc to anchor the sweep in the psi provenance system.
...
After runs complete, analyze with:
  /psi-bgw-gw-conv-analyze calcs:conv_sigma_{param}/val_{v1},conv_sigma_{param}/val_{v2},... vbm:ik={ik},n={n} cbm:ik={ik},n={n} sweep:{param}
```
